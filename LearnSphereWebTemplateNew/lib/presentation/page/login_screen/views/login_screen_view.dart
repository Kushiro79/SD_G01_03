...
class LoginScreenView extends GetView<LoginScreenController> {
                  ...
                  const Padding(
                   ...
                   Padding(padding: const EdgeInsets.symmetric(vertical: 24, horizontal: 10),
                    child: GetBuilder<LoginScreenController>(
                      builder: (controller) {
                        return TextField(
                    onChanged: (value) => loginScreenController.updateEmail(value),
                    decoration: InputDecoration(
                      hintText: 'Enter your username',
                      labelText: 'Username or Email',
                      errorText: loginScreenController.isValidEmail.value ? null : 'Invalid email address',
 ...
 Padding(padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 10),
                    child: GetBuilder<LoginScreenController>(
                        builder: (context) {
                          return TextField(
                             onChanged: (value) => loginScreenController.updatePassword(value),
                              obscureText: loginScreenController.showPassword,
                              decoration: InputDecoration(
                                contentPadding: const EdgeInsets.symmetric(horizontal: 20, vertical: 20),
                                hintText: 'Min. 8 characters...',
                                labelText: 'Password',
                                errorText: loginScreenController.isValidPassword.value ? null : 'Invalid password',
