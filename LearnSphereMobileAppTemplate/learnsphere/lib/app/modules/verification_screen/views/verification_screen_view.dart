            ...
            child: Column(
              ...
              children: [
                ...
                const Padding(padding: EdgeInsets.only(top: 40, bottom: 20),
                  child: Center(child: Text('OTP Verification', style: TextStyle(fontSize: 32, fontFamily: 'Urbanist-bold'))),
                ),
                const Center(child: Text('Enter the verification code we just\n     sent on your email address.', style: TextStyle(fontSize: 14, fontFamily: 'Urbanist-medium', color: Color(0xff64748B)))),
                ...
                Padding(
                  ...
                  child: ListTile(
                    leading: Text('Resend code in', style: TextStyle(fontSize: 12, color: Colors.grey[500], fontFamily: 'Urbanist-semibold'), overflow: TextOverflow.ellipsis),
                    trailing: const Text('2:13', style: TextStyle(fontSize: 12, color: AppColor.purple, fontFamily: 'Urbanist-semibold'), overflow: TextOverflow.ellipsis),
                  ),
                ),

                Padding(padding: const EdgeInsets.only(bottom: 16, top: 15),
                  child: Center(
